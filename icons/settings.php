            ...
            try{
                ...
                if(isset($_POST["sent"])){
                    ...
                    if(!empty($_POST['passwd0']) || !empty($_POST['passwd1']) || !empty($_POST['passwd2'])){
                        ...
                        if(empty($_POST['passwd1']) || empty($_POST['passwd2'])) $msg.="New password cannot be empty</br>";
    ...
    ?>
            ...
            <form onsubmit="return validate()" name="form1" method="post">
                <label class="row">
                    ...
                    <input type="text" class="in1" value="<?php if(isset($_POST["uname"])) echo $_POST['name']; else echo $data['name']; ?>" name="uname" required>
                </label>
                <label class="row">
                ...
                <div class="row">
                    <input type="submit" value="UPDATE" class="in2" class="sent">
